...
# however, if a $10 minimum payment exceeds the balance,
# then the minimum payment is the balance.
# Write a program to return the minimum payment.
...
def computeMinimumPayment( balance ):
    ...
    getPercent = float(balance * 0.021)

    if balance < 10:
        return balance
    elif balance > 10 and getPercent > 10:
